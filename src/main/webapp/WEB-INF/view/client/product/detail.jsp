    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
                ...
                <head>
                    <meta charset="utf-8">
                    <title> ${detailPro.name} - Laptopshop</title>
                                    ...
                                    <div class="row g-4">
                                        <div class="col-lg-6">
                                            <div class="border rounded">
                                                <a href="#">
                                                    <img src="/images/product/${detailPro.image}"
                                                        class="img-fluid rounded" alt="Image">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <h4 class="fw-bold mb-3"> ${detailPro.name}</h4>
                                            <p class="mb-3">${detailPro.factory}</p>
                                            <h5 class="fw-bold mb-3">
                                                <fmt:formatNumber type="number" value="${detailPro.price}" /> đ
                                            ...
                                            <!-- <form action="/add-product-from-view-detail" method="post"
                                                modelAttribute="detailPro"> -->
                                                <input type="hidden" name="${_csrf.parameterName}"
                                                    value="${_csrf.token}" />
                                                <input class="form-control d-none" type="text" value="${detailPro.id}"
                                                    name="id" />

                                                <input class="form-control d-none" type="text" name="quantity"
                                                    id="cartDetails0.quantity" value="1" />
                                                <button data-product-id="${detailPro.id}"
