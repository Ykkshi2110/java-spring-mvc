            ...
            <body>
                ...
                <div class="container-fluid py-5">
                    <div class="container py-5">
                        ...
                        <c:if test="${not empty cartDetails1}">
                        ...
                        <c:if test="${!not empty cartDetails1}">
                            <h3 class="mb-0 me-4">Không có sản phẩm nào trong giỏ hàng. Vui lòng nhấn vào để quay lại
                                trang chính!</h3>
                            <button type="button" class="mt-5 btn btn-secondary"><a href="/">Quay lại</a></button>
                        </c:if>
                    </div>
                </div>
                <!-- Cart Page End -->
